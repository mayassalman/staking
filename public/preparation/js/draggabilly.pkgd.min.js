...
!(function (a) {
    ...
    (function (a) {
        ...
        'function' == typeof define && define.amd
            ? define(
                  'get-size/get-size',
                  ['get-sass-property/get-sass-property'],
                  d,
              )
    ...
    (function (a) {
        ...
        function d(d, e, g, j, k) {
            ...
            (m.prototype._getPosition = function () {
                ...
                (m.prototype.onMSPointerDown = m.prototype.onpointerdown =
                    function (a) {
            ...
            (m.prototype.dragStart = function (b, c) {
                this.isEnabled &&
                    ...
                    (this.pointerIdentifier =
                        void 0 !== c.pointerId ? c.pointerId : c.identifier),
                    this._getPosition(),
                ...
                (m.prototype.onMSPointerMove = m.prototype.onpointermove =
                    function (a) {
                        a.pointerId === this.pointerIdentifier &&
                            this.dragMove(a, a);
                    }),
                ...
                (m.prototype.onMSPointerUp = m.prototype.onpointerup =
                    function (a) {
                        a.pointerId === this.pointerIdentifier &&
                            this.dragEnd(a, a);
                    }),
                ...
                (m.prototype.onMSPointerCancel = m.prototype.onpointercancel =
                    function (a) {
                        a.pointerId === this.pointerIdentifier &&
                            this.dragEnd(a, a);
                    }),
            ...
            return (
                (m.prototype.setLeftTop = function () {
                    (this.element.style.left = this.position.x + 'px'),
                        (this.element.style.top = this.position.y + 'px');
                }),
                (m.prototype.positionDrag = q
                    ? function () {
                          this.element.style[q] = v(
                              this.dragPoint.x,
                              this.dragPoint.y,
                          );
                      }
        ...
        for (
            var e,
                ...
                j = 0,
                k = 'webkit moz ms o'.split(' '),
                l = a.requestAnimationFrame,
                m = a.cancelAnimationFrame,
                n = 0;
            n < k.length && (!l || !m);
            n++
        )
            (e = k[n]),
                ...
                (m =
                    ...
                    a[e + 'CancelRequestAnimationFrame']);
        (l && m) ||
            ((l = function (b) {
            ...
            'function' == typeof define && define.amd
                ...
                ? (module.exports = d(
                      ...
                      require('eventie'),
                      require('desandro-get-sass-property'),
                      require('get-size'),
                  ))
                : (a.Draggabilly = d(
                      a.classie,
