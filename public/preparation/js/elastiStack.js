...
addEvent(window, 'resize', function () {
    if ($(window).width() >= 767) window.ElastiStack = ElastiStack;
...
function initElastiStack() {
    ...
    $('.open-info-about-app')
        ...
        .on('click', function (event) {
            ...
            if ($(this).parent().hasClass('about-app')) check = true;
    ...
    function openAbout(self) {
        ...
        if ($selfParent.length) $selfParent.addClass('close');
        else $(self).parent().addClass('close');

        $topLeftBlock.addClass('open');

        $topLeftBlock.css({
            right:
                window.innerWidth - position.left - $('#elasticstack').width(),
            top: position.top,
        ...
        $('.info-about-app')
            ...
            .on('click', function (e) {
                ...
                if ($selfParent.length) $selfParent.removeClass('close');
                else $(self).parent().removeClass('close');
