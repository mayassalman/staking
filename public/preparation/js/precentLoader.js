...
(function checkSVG() {
    ...
    if (navigator.userAgent.search('Firefox') > -1) {
        ...
        try {
            ...
            if (svgDoc !== null) var g10 = svgDoc.getElementById('g10');
            if (g10 === null) {
            ...
            if (svg) svg.className = svg.className.replace(' opacity', '');
        }
    } else {
            ...
            if (!imgs) {
                ...
                for (var i = 0; i < imgs.length; i++) {
                    ...
                    addEvent(img, 'load', function () {
                        ...
                        imgLoaded++;
                        self.statusPrecent = parseInt(
                            (imgLoaded * 100) / imgs.length,
                            10,
                        );
                        self.element.innerHTML =
                            parseInt(self.statusPrecent, 10) + '%';
